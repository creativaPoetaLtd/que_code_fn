...
type FilterType = "all" | "users" | "groups" | "contacts" | "invitations";
  ...
  return (
    ...
    >
      ...
      <div className="p-3 sm:p-4 border-b border-gray-200 flex-shrink-0">
        ...
        <div className="mb-3">
          <p className="text-xs font-medium text-gray-600 uppercase tracking-wide mb-2">
            {activeFilter === "contacts" && "My Contacts"}
            {activeFilter === "invitations" && "Pending Invitations"}
            {(activeFilter === "all" ||
              activeFilter === "users" ||
              activeFilter === "groups") &&
              "Conversations"}
      ...
      <div className="flex-1 overflow-y-auto">
        {activeFilter === "contacts" ? (
          <ContactsList onStartChat={handleStartNewChat} className="h-full" />
        ) : activeFilter === "invitations" ? (
          <InvitationsList className="h-full" />
