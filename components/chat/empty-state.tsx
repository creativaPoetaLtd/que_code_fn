        ...
        switch (filterType) {
            case "users":
                return {
                    ...
                    actions: [
                        { onClick: onStartNewChat, icon: MessageCirclePlus, label: "Start New Chat", variant: "default" as const },
                        { onClick: onAddContact, icon: UserPlus, label: "Add Contact", variant: "outline" as const },
                    ]
                }
            case "groups":
                return {
                    ...
                    actions: [
                        { onClick: onViewMyGroups, icon: Users, label: "My Groups", variant: "default" as const },
                        { onClick: onJoinGroupByLink, icon: Link, label: "Join Group", variant: "outline" as const },
                    ]
                }
            default:
                return {
                    ...
                    actions: [
                        { onClick: onStartNewChat, icon: MessageCirclePlus, label: "Start New Chat", variant: "default" as const },
                        { onClick: onViewMyGroups, icon: Users, label: "My Groups", variant: "outline" as const },
                        { onClick: onAddContact, icon: UserPlus, label: "Add Contact", variant: "outline" as const },
                    ]
                }
        }
