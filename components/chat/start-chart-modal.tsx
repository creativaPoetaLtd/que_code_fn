            ...
            <Dialog open={isOpen} onOpenChange={(open) => !open && handleClose()}>
                <DialogContent className="sm:max-w-md">
                    ...
                    <div className="py-8 text-center">
                        ...
                        <p className="text-gray-500">Please log in to start new chats</p>
                    </div>
                </DialogContent>
            </Dialog>
        )
                ...
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2">
                        ...
                        {availableContacts.length > 0 && (
                            <span className="ml-2 text-sm font-normal text-gray-500">({availableContacts.length} contacts)</span>
                        )}
                    </DialogTitle>
                </DialogHeader>
                    ...
                    <div className="flex-1 overflow-y-auto">
                        {isLoading ? (
                            ...
                            <div className="text-center py-8">
                                ...
                                <p className="text-gray-500 mb-2">No available contacts to chat with</p>
                                <p className="text-sm text-gray-400 mb-4">All your contacts already have active conversations</p>
                            </div>
                        ) : (
                            <div className="text-center py-8">
                                <Users size={40} className="mx-auto mb-2 text-gray-400" />
